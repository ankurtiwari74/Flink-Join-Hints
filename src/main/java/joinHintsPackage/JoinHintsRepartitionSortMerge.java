...
public class JoinHintsRepartitionSortMerge {
    public static void main(String[] args) throws Exception{
        ...
        DataSet<Tuple3<Integer, String, String>> joined = personSet.fullOuterJoin(locationSet, JoinHint.REPARTITION_SORT_MERGE).where(0)

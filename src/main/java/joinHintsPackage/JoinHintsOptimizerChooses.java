...
public class JoinHintsOptimizerChooses {
    public static void main(String[] args) throws Exception{
        ...
        DataSet<Tuple3<Integer, String, String>> joined = personSet.fullOuterJoin(locationSet, JoinHint.OPTIMIZER_CHOOSES).where(0)

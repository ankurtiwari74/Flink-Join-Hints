...
public class JoinHintsRepartitionHashSecond {
    public static void main(String[] args) throws Exception{
        ...
        DataSet<Tuple3<Integer, String, String>> joined = personSet.fullOuterJoin(locationSet, JoinHint.REPARTITION_HASH_SECOND).where(0)

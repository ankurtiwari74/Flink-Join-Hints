...
public class JoinHintsBroadcastHashFirst {
    public static void main(String[] args) throws Exception{
        ...
        DataSet<Tuple3<Integer, String, String>> joined = personSet.fullOuterJoin(locationSet, JoinHint.BROADCAST_HASH_FIRST).where(0)
